...
# GNU Radio version: v3.11.0.0git-680-g54361809
...
class simple(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.network_tcp_sink_0 = network.tcp_sink(gr.sizeof_gr_complex, 1, '127.0.0.1', 6000,2)
        ...
        self.connect((self.iridium_iuchar_to_complex_2, 0), (self.network_tcp_sink_0, 0))
    ...
    def update_frequency(self):
        ...
        new_freq = current_freq + 10e6  # Increment by 10 MHz
